 ...
 */
public class RegPresentIndic extends Verb {
    private String heShe;

    public RegPresentIndic(String inEnglish, String spInfinitive) {
        super(inEnglish, spInfinitive);
        this.heShe = inEnglish + "s";
        verbTense = "present ind.";
    }

    public RegPresentIndic(String inEnglish, String spInfinitive, String heShe) {
        super(inEnglish, spInfinitive);
        this.heShe = heShe;
        verbTense = "present ind.";
    }
