 ...
 */
public class IrregPreteriteIndic extends Verb {
    private String yo;
    private String tu;
    ...
    public IrregPreteriteIndic(String inEnglish, String spInfinitive, String yo, String tu,
